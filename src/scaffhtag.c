...
int main(int argc, char **argv)
{
    ...
    if(argc < 2)
    {
         ...
         printf("       reads    (4)    - step 1 and 2: minimum number of reads per barcode\n");
         printf("       link     (3)     - step 1 and 2: minimum number of shared barcodes\n");
         printf("       read-s1  (4)     - step 1: minimum number of reads per barcode\n");
         printf("       read-s2  (4)    - step 2: minimum number of reads per barcode\n");
         printf("       link-s1  (3)     - step 1: minimum number of shared barcodes\n");
         printf("       link-s2  (3)    - step 2: minimum number of shared barcodes\n");
